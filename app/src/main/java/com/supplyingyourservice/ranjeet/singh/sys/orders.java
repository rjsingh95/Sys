...
public class orders extends AppCompatActivity {
    ...
    private Context mContext = orders.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.supplyingyourservice.ranjeet.singh.sys.R.layout.activity_order);
        ...
        rv.setLayoutManager(new LinearLayoutManager(orders.this));
                ...
                friendsViewHolder.call.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        try {
                            ...
                            if (ActivityCompat.checkSelfPermission(orders.this, android.Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                ...
                friendsViewHolder.duration.setText(friends.getDelivery_time());
                        ...
                        friendsViewHolder.make_offer.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                final AlertDialog.Builder alert= new AlertDialog.Builder(orders.this);
                        ...
                        database.child("products").child(list_user_id).addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(DataSnapshot dataSnapshot) {
                                ...
                                if(dataSnapshot.hasChild("productdp")) {
                                    ...
                                    friendsViewHolder.setImage(title,orders.this);
